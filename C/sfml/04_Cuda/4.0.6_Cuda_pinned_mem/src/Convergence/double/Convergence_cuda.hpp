...
public:
  Convergence_CUDA(ColorMap* _colors, int _max_iters){
    ...
    host_value_iteration = (unsigned short *)malloc( sizeof( unsigned short ) * WIDTH*HEIGHT );
    device_value_iteration = (unsigned short *)malloc( sizeof( unsigned short ) * WIDTH*HEIGHT );
    cudaMallocHost( (void**)&device_value_iteration, WIDTH*HEIGHT * sizeof( unsigned short ) );
    //CUDA_MALLOC( (void**)&device_value_iteration, WIDTH*HEIGHT * sizeof( unsigned short ) );
