#ifndef _Convergence_dp_x86_omp_
#define _Convergence_dp_x86_omp_
...
class Convergence_dp_x86_omp : public Convergence {

public:

  Convergence_dp_x86_omp() {
  }

  Convergence_dp_x86_omp(ColorMap* _colors, int _max_iters){
    colors    = _colors;
