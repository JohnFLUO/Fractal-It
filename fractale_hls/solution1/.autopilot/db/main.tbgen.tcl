...
set C_modelArgMapList {[ 
	{ "Name" : "clk", "interface" : "wire", "bitwidth" : 1, "direction" : "READONLY", "bitSlice":[{"low":0,"up":0,"cElement": [{"cName": "main.clk.m_if.Val","cData": "bool","bit_use": { "low": 0,"up": 0},"cArray": [{"low" : 0,"up" : 0,"step" : 1}]}]}]} , 
 	...
 	{ "Name" : "zoom", "interface" : "wire", "bitwidth" : 8, "direction" : "READONLY", "bitSlice":[{"low":0,"up":7,"cElement": [{"cName": "main.zoom.m_if.Val.V","cData": "uint8","bit_use": { "low": 0,"up": 7},"cArray": [{"low" : 0,"up" : 0,"step" : 1}]}]}]} , 
...
set portList { 
	...
	{ zoom sc_in sc_lv 8 signal 5 clk } 
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1", "3", "6"],
		...
		"II" : "0",
		"VariableLatency" : "1", "ExactLatency" : "-1", "EstimateLatencyMin" : "2", "EstimateLatencyMax" : "101",
		"Combinational" : "0",
		"Datapath" : "0",
		"ClockEnable" : "0",
		"HasSubDataflow" : "0",
		...
		"Port" : [
			...
			{"Name" : "clk_form", "Type" : "None", "Direction" : "I",
				"SubConnect" : [
					{"ID" : "1", "SubInstance" : "grp_convergence_fu_104", "Port" : "clk"}]},
			{"Name" : "reset_form", "Type" : "None", "Direction" : "I",
				"SubConnect" : [
					{"ID" : "1", "SubInstance" : "grp_convergence_fu_104", "Port" : "reset"}]},
			{"Name" : "zoom_form", "Type" : "None", "Direction" : "I",
				"SubConnect" : [
					{"ID" : "1", "SubInstance" : "grp_convergence_fu_104", "Port" : "zoom"}]},
			{"Name" : "offset_X_form", "Type" : "None", "Direction" : "I",
				"SubConnect" : [
					{"ID" : "1", "SubInstance" : "grp_convergence_fu_104", "Port" : "offset_X"}]},
			{"Name" : "offset_Y_form", "Type" : "None", "Direction" : "I",
				"SubConnect" : [
					{"ID" : "1", "SubInstance" : "grp_convergence_fu_104", "Port" : "offset_Y"}]},
			{"Name" : "sc_fifo_chn_1_form3", "Type" : "Fifo", "Direction" : "O",
				"SubConnect" : [
					{"ID" : "1", "SubInstance" : "grp_convergence_fu_104", "Port" : "s_out"}]},
			{"Name" : "x_form", "Type" : "Vld", "Direction" : "O",
				"SubConnect" : [
					{"ID" : "1", "SubInstance" : "grp_convergence_fu_104", "Port" : "out_x"}]},
			{"Name" : "y_form", "Type" : "Vld", "Direction" : "O",
				"SubConnect" : [
					{"ID" : "1", "SubInstance" : "grp_convergence_fu_104", "Port" : "out_y"}]},
			{"Name" : "clk_form1", "Type" : "None", "Direction" : "I",
				"SubConnect" : [
					{"ID" : "3", "SubInstance" : "grp_dimage_fu_126", "Port" : "clk"}]},
			{"Name" : "reset_form2", "Type" : "None", "Direction" : "I",
				"SubConnect" : [
					{"ID" : "3", "SubInstance" : "grp_dimage_fu_126", "Port" : "reset"}]},
			{"Name" : "sc_fifo_chn_1_form", "Type" : "Fifo", "Direction" : "I",
				"SubConnect" : [
					{"ID" : "3", "SubInstance" : "grp_dimage_fu_126", "Port" : "counter"}]},
			{"Name" : "couleur_form", "Type" : "Vld", "Direction" : "O",
				"SubConnect" : [
					{"ID" : "3", "SubInstance" : "grp_dimage_fu_126", "Port" : "couleur"}]},
			{"Name" : "convergence_ssdm_thread_M_do_convergence", "Type" : "None", "Direction" : "I",
				"SubConnect" : [
					{"ID" : "1", "SubInstance" : "grp_convergence_fu_104", "Port" : "convergence_ssdm_thread_M_do_convergence"}]},
			{"Name" : "dimage_ssdm_thread_M_do_image", "Type" : "None", "Direction" : "I",
				"SubConnect" : [
					{"ID" : "3", "SubInstance" : "grp_dimage_fu_126", "Port" : "dimage_ssdm_thread_M_do_image"}]},
			{"Name" : "color", "Type" : "Memory", "Direction" : "I",
				"SubConnect" : [
					{"ID" : "3", "SubInstance" : "grp_dimage_fu_126", "Port" : "color"}]}]},
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.grp_convergence_fu_104", "Parent" : "0", "Child" : ["2"],
		"CDFG" : "convergence",
		"Protocol" : "ap_ctrl_hs",
		"ControlExist" : "0", "ap_start" : "0", "ap_ready" : "0", "ap_done" : "0", "ap_continue" : "0", "ap_idle" : "0",
		"Pipeline" : "Dataflow", "UnalignedPipeline" : "0", "RewindPipeline" : "0", "ProcessNetwork" : "1",
		"II" : "0",
		"VariableLatency" : "1", "ExactLatency" : "-1", "EstimateLatencyMin" : "1", "EstimateLatencyMax" : "100",
		"Combinational" : "0",
		"Datapath" : "0",
		"ClockEnable" : "0",
		"HasSubDataflow" : "0",
		...
		"Port" : [
			...
			{"Name" : "convergence_ssdm_thread_M_do_convergence", "Type" : "None", "Direction" : "I"}]},
	{"ID" : "2", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.grp_convergence_fu_104.grp_convergence_do_convergence_fu_76", "Parent" : "1",
		...
		"Port" : [
			...
			{"Name" : "out_x", "Type" : "Vld", "Direction" : "O"},
			{"Name" : "out_y", "Type" : "Vld", "Direction" : "O"}]},
	{"ID" : "3", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.grp_dimage_fu_126", "Parent" : "0", "Child" : ["4"],
		"CDFG" : "dimage",
		"Protocol" : "ap_ctrl_hs",
		"ControlExist" : "0", "ap_start" : "0", "ap_ready" : "0", "ap_done" : "0", "ap_continue" : "0", "ap_idle" : "0",
		"Pipeline" : "Dataflow", "UnalignedPipeline" : "0", "RewindPipeline" : "0", "ProcessNetwork" : "1",
	...
	{"ID" : "4", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.grp_dimage_fu_126.grp_dimage_do_image_fu_58", "Parent" : "3", "Child" : ["5"],
		...
		"Port" : [
			...
			{"Name" : "couleur", "Type" : "Vld", "Direction" : "O"},
			{"Name" : "color", "Type" : "Memory", "Direction" : "I"}]},
	{"ID" : "5", "Level" : "3", "Path" : "`AUTOTB_DUT_INST.grp_dimage_fu_126.grp_dimage_do_image_fu_58.color_U", "Parent" : "4"},
