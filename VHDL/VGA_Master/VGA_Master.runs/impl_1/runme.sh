...
HD_PWD='/home/jonathan/Documents/ENSEIRB/PR310/Fractal-It/VHDL/VGA_Master/VGA_Master.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log top_VGA_master.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source top_VGA_master.tcl -notrace
