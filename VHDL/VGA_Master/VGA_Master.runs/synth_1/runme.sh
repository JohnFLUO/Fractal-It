...
HD_PWD='/home/jonathan/Documents/ENSEIRB/PR310/Fractal-It/VHDL/VGA_Master/VGA_Master.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log top_VGA_master.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source top_VGA_master.tcl
