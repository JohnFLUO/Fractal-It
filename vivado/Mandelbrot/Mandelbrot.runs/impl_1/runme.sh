...
HD_PWD='/net/e/floupias001/FRACTALE/fractale/Fractale-It/vivado/Mandelbrot/Mandelbrot.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log top_Mandelbrot.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source top_Mandelbrot.tcl -notrace
